...
public class Transition {
	...
	public Transition(Node n1, Node n2, int freccia) {
		...
		if(this.freccia == -1) {
				this.arrow = new ArrowPanel(getCenter(n1.getPosX(), n1.getPosY(), n1.getPanel().getSize().width,  n1.getPanel().getSize().height), 
				getCenter(n2.getPosX(), n2.getPosY(), n2.getPanel().getSize().width,  n2.getPanel().getSize().height));
	...
	public void paintTransition() {
		...
		arrow.setSize(this.tranWF.panel.getSize());
